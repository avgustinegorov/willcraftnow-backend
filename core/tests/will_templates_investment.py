WILL_INVESTMENT_ALLOCATIONS_TITLE_BLOCK_TEMPLATE = """
INVESTMENT ALLOCATIONS
""".lstrip()


def WILL_INVESTMENT_1_ALLOCATIONS_BLOCK_TEMPLATE(*args):
    return """
    %(numbering)d.Subject to the payment of all my Expenses, I give 100.00%% of my interest in the Investment Account held with {investment_institution_name} with account number {investment_account_number} ("{investment_institution_name} {investment_account_number}"), to {entity_1_name} (holder of NRIC No. {entity_1_nric}), residing at {entity_1_address} ("{entity_1_name}") absolutely and free from all encumbrances.
    """.strip()


def WILL_INVESTMENT_1_ALLOCATIONS_LT_100_BLOCK_TEMPLATE(*args):
    return """
    %(numbering)d.Subject to the payment of all my Expenses, I give {allocation_percentage:.2f}%% of my interest in the Investment Account held with {investment_institution_name} with account number {investment_account_number} ("{investment_institution_name} {investment_account_number}"), to {entity_1_name} (holder of NRIC No. {entity_1_nric}), residing at {entity_1_address} ("{entity_1_name}") absolutely and free from all encumbrances, and the remainder shall be distributed as part of my Residual Estate.
    """.strip()


def WILL_INVESTMENT_2_ALLOCATIONS_BLOCK_TEMPLATE(*args):
    return """
    %(numbering)d.Subject to the payment of all my Expenses, I give my interest in the Investment Account held with {investment_institution_name} with account number {investment_account_number} ("{investment_institution_name} {investment_account_number}"), to the following persons in the corresponding proportions: i.{allocation_percentage:.2f}%% to {entity_1_name} (holder of NRIC No. {entity_1_nric}), residing at {entity_1_address} ("{entity_1_name}") absolutely and free from all encumbrances; and ii.{allocation_percentage:.2f}%% to {entity_2_name} (holder of NRIC No. {entity_2_nric}), residing at {entity_2_address} ("{entity_2_name}") absolutely and free from all encumbrances (for the purpose of clauses %(numbering)d to %(numbering_plus_2)d, together with the named Beneficiaries in sub-clause i above, the ﬁMain Substitutesﬂ).
    """.strip()


def WILL_INVESTMENT_2_ALLOCATIONS_LT_100_BLOCK_TEMPLATE(*args):
    return """
    %(numbering)d.Subject to the payment of all my Expenses, I give my interest in the Investment Account held with {investment_institution_name} with account number {investment_account_number} ("{investment_institution_name} {investment_account_number}"), to the following persons in the corresponding proportions:
...
def WILL_INVESTMENT_3_ALLOCATIONS_BLOCK_TEMPLATE(*args):
    return """
    %(numbering)d.Subject to the payment of all my Expenses, I give my interest in the Investment Account held with {investment_institution_name} with account number {investment_account_number} ("{investment_institution_name} {investment_account_number}"), to the following persons in the corresponding proportions:
    i.{allocation_percentage:.2f}%% to {entity_1_name} (holder of NRIC No. {entity_1_nric}), residing at {entity_1_address} ("{entity_1_name}") absolutely and free from all encumbrances;
...
WILL_INVESTMENT_3_ALLOCATIONS_LT_100_BLOCK_TEMPLATE = (
    WILL_INVESTMENT_3_ALLOCATIONS_BLOCK_TEMPLATE
)


def WILL_INVESTMENT_BENEFICIARY_1_DIES_BLOCK_TEMPLATE(num_beneficiaries, *args):
    return (
        """
    If {entity_1_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, then the interest in {investment_institution_name} {investment_account_number} which {entity_1_name} would otherwise have received under this Will shall be distributed equally amongst {entity_1_name}'s surviving issues absolutely and free from all encumbrances so long as they survive me for more than thirty (30) days
    """.strip()
        + (
            "."
...
def WILL_1_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_1_DIES_LT_100_BLOCK_TEMPLATE(
    num_beneficiaries, *args
):
    return (
        """
...
def WILL_2_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_1_DIES_BLOCK_TEMPLATE(*args):
    return """
    If {entity_1_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, I give the interest in {investment_institution_name} {investment_account_number} which {entity_1_name} would otherwise have received under this Will, to the following persons in the corresponding proportions:
...
def WILL_2_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_2_DIES_BLOCK_TEMPLATE(*args):
    return """
    If {entity_2_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, I give the interest in {investment_institution_name} {investment_account_number} which {entity_2_name} would otherwise have received under this Will, to the following persons in the corresponding proportions:
...
def WILL_2_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_2_DIES_LT_100_BLOCK_TEMPLATE(*args):
    return """
    If {entity_2_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, I give the interest in {investment_institution_name} {investment_account_number} which {entity_2_name} would otherwise have received under this Will, to the following persons in the corresponding proportions:
...
def WILL_2_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_3_DIES_BLOCK_TEMPLATE(*args):
    return """
    If {entity_3_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, I give the interest in {investment_institution_name} {investment_account_number} which {entity_3_name} would otherwise have received under this Will, to the following persons in the corresponding proportions:
...
def WILL_2_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_3_DIES_LT_100_BLOCK_TEMPLATE(*args):
    return """
    If {entity_3_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, I give the interest in {investment_institution_name} {investment_account_number} which {entity_3_name} would otherwise have received under this Will, to the following persons in the corresponding proportions:
...
def WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_1_DIES_BLOCK_TEMPLATE(*args):
    return """
    If {entity_1_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, I give the interest in {investment_institution_name} {investment_account_number} which {entity_1_name} would otherwise have received under this Will, to the following persons in the corresponding proportions:
    i.{sub_allocation_percentage:.2f}% (being {sub_entity_1_1_ea_pct:.2f}% of my total interest in the same) to {sub_entity_1_1_name} (holder of NRIC No. {sub_entity_1_1_nric}), residing at {sub_entity_1_1_address} ("{sub_entity_1_1_name}") absolutely and free from all encumbrances;
...
WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_1_DIES_LT_100_BLOCK_TEMPLATE = (
    WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_1_DIES_BLOCK_TEMPLATE
)


def WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_2_DIES_BLOCK_TEMPLATE(*args):
    return """
    If {entity_2_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, I give the interest in {investment_institution_name} {investment_account_number} which {entity_2_name} would otherwise have received under this Will, to the following persons in the corresponding proportions:
    i.{sub_allocation_percentage:.2f}% (being {sub_entity_2_1_ea_pct:.2f}% of my total interest in the same) to {sub_entity_2_1_name} (holder of NRIC No. {sub_entity_2_1_nric}), residing at {sub_entity_2_1_address} ("{sub_entity_2_1_name}") absolutely and free from all encumbrances;
...
WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_2_DIES_LT_100_BLOCK_TEMPLATE = (
    WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_2_DIES_BLOCK_TEMPLATE
)


def WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_3_DIES_BLOCK_TEMPLATE(*args):
    return """
    If {entity_3_name} should die during my lifetime, or fail to survive me for more than thirty (30) days, I give the interest in {investment_institution_name} {investment_account_number} which {entity_3_name} would otherwise have received under this Will, to the following persons in the corresponding proportions:
    i.{sub_allocation_percentage:.2f}% (being {sub_entity_3_1_ea_pct:.2f}% of my total interest in the same) to {sub_entity_3_1_name} (holder of NRIC No. {sub_entity_3_1_nric}), residing at {sub_entity_3_1_address} ("{sub_entity_3_1_name}") absolutely and free from all encumbrances;
...
WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_3_DIES_LT_100_BLOCK_TEMPLATE = (
    WILL_3_SUB_BENEFICIARIES_INVESTMENT_BENEFICIARY_3_DIES_BLOCK_TEMPLATE
)
