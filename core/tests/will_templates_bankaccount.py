...
def WILL_BANK_ACCOUNT_2_ALLOCATIONS_BLOCK_TEMPLATE(has_amount_allocation):
    ...
    """
        ...
        + " "
        + """
    absolutely and free from all encumbrances (for the purpose of clauses %(numbering)d to %(numbering_plus_2)d, together with the named Beneficiaries in sub-clause i above, the ﬁMain Substitutesﬂ).
    """.strip()
    )
...
def WILL_BANK_ACCOUNT_2_ALLOCATIONS_LT_100_BLOCK_TEMPLATE(has_amount_allocation):
    ...
    """
        ...
        + " "
        + """
    absolutely and free from all encumbrances (for the purpose of clauses %(numbering)d to %(numbering_plus_2)d, together with the named Beneficiaries in sub-clause i above, the ﬁMain Substitutesﬂ); and
...
ii.${allocation_amount:.2f} to {entity_2_name} (holder of NRIC No. {entity_2_nric}), residing at {entity_2_address} ("{entity_2_name}") absolutely and free from all encumbrances (for the purpose of clauses %(numbering)d to %(numbering_plus_2)d, together with the named Beneficiaries in sub-clause i above, the ﬁMain Substitutesﬂ).
""".strip()
...
def WILL_BANK_ACCOUNT_3_ALLOCATIONS_BLOCK_TEMPLATE(has_amount_allocation):
    ...
    """
        ...
        + " "
        + """
    absolutely and free from all encumbrances (for the purpose of clauses %(numbering)d to %(numbering_plus_3)d, together with the named Beneficiaries in sub-clauses i-ii above, the ﬁMain Substitutesﬂ); and
...
iii.${allocation_amount:.2f} to {entity_3_name} (holder of NRIC No. {entity_3_nric}), residing at {entity_3_address} ("{entity_3_name}") absolutely and free from all encumbrances (for the purpose of clauses %(numbering)d to %(numbering_plus_3)d, together with the named Beneficiaries in sub-clauses i-ii above, the ﬁMain Substitutesﬂ).
""".strip()
...
def WILL_3_SUB_BENEFICIARIES_BANK_ACCOUNT_BENEFICIARY_1_DIES_BLOCK_TEMPLATE(
    ...
    """
        ...
        + " "
        + """
    absolutely and free from all encumbrances (for the purpose of this clause, together with the named Substitute Beneficiaries in sub-clauses i-ii above, the ﬁApplicable Substitutesﬂ); and
    iv.the remainder shall be distributed as part of my Residual Assets.
...
def WILL_2_SUB_BENEFICIARIES_BANK_ACCOUNT_BENEFICIARY_1_DIES_BLOCK_TEMPLATE(
    ...
    """
        ...
        + " "
        + """
    absolutely and free from all encumbrances (for the purpose of this clause, together with the named Substitute Beneficiaries in sub-clause i above, the ﬁApplicable Substitutesﬂ).
    Provided Always that if any of the Applicable Substitutes, should die during my lifetime, or fail to survive me for more than thirty (30) days, then any gift devise or bequest of my interest in {bank_name} {bank_account_number} which that Applicable Substitute would otherwise have received under this Will shall be distributed equally amongst the issues of that Applicable Substitute so long as they survive me for more than thirty (30) days, and if that Applicable Substitute does not have any issues who have survived me for more than thirty (30) days, then the same shall be distributed equally amongst all the Applicable Substitutes who have survived me for more than thirty (30) days.
    """.strip()
    )
...
def WILL_2_SUB_BENEFICIARIES_BANK_ACCOUNT_BENEFICIARY_1_DIES_LT_100_BLOCK_TEMPLATE(
    ...
    """
        ...
        + " "
        + """
    absolutely and free from all encumbrances (for the purpose of this clause, together with the named Substitute Beneficiaries in sub-clause i above, the ﬁApplicable Substitutesﬂ); and
    iii.the remainder shall be distributed as part of my Residual Assets.
    Provided Always that if any of the Applicable Substitutes, should die during my lifetime, or fail to survive me for more than thirty (30) days, then any gift devise or bequest of my interest in {bank_name} {bank_account_number} which that Applicable Substitute would otherwise have received under this Will shall be distributed equally amongst the issues of that Applicable Substitute so long as they survive me for more than thirty (30) days, and if that Applicable Substitute does not have any issues who have survived me for more than thirty (30) days, then the same shall be distributed equally amongst all the Applicable Substitutes who have survived me for more than thirty (30) days.
    """.strip()
    )
