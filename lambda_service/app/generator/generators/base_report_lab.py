...
class BaseReportLabGenerator(BasePdfGenerator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logo_image = os.path.join(
            this_directory, "assets", "img", "logo.png")
    ...
    def get_content(self):
        return {"blocks": self.content, "entityMap": {}}

    def generate_base(self):
        """ Creates a Base PDF that all of the other methods can work on top of """
        self.doc = self.doc_class(self.stream, pagesize=self.page_size)
        # Setting the margins
